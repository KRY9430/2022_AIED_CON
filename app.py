...
st.write(":pencil2: Saliency map을 이용하여 동물을 분류하는 모델의 분류결과 뿐 아니라 모델의 해석가능성을 체험할 수 있게 구성하였다. 나만의 분류 기준과 인공지능의 분류 기준을 비교하여 인공지능의 장단점을 인식할 수 있게 하였고, 인공지능이 절대적인 정답을 주는 것이 아니라 문제 상황에서 활용할 수 있는 도구임을 인식할 수 있도록 하였다.")
